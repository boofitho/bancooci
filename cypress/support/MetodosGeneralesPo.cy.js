...
class MetodosGenerales{
    ...
    ArchivoNubeV(URL_VARIABLES){
        ...
        cy.log("🔚🏁🏃🏃‍♂️ Finaliza metodo descarga de archivo")

      }   


    DescargaArchivoComplementos(URL_Datos, nombreArchivo){
      cy.log("👇✅⏳🏃‍➡️🏃‍♂️‍➡️ Inicia metodo descarga de archivo")
      ...
      cy.writeFile("cypress/fixtures/"+nombreArchivo+".xlsx", fileBuffer, 
        { encoding: 'binary' });      
      cy.log("📁🗄️🗃️ archivo descargado con nombre: "+ nombreArchivo)
       ...
       DescargaImagen(data){
        cy.log("✅⏳🏃‍➡️🏃‍♂️‍➡️ inicia metodo descarga imagen")
        ...
        cy.request({
          ...
          cy.log("🎞️📷📸 imagen descargada con nombre: "+data.NombreArchivo)
  
        });

        cy.log("🔚🏁🏃🏃‍♂️ finaliza metodo descarga imagen")

     }

      Dashboard(URL){
      cy.log("✅⏳🏃‍➡️🏃‍♂️‍➡️ Inicia metodo Dashboard")

      cy.visit(URL)
      cy.oculto()
      
      cy.log("🔚🏁🏃🏃‍♂️ Finaliza metodo Dashboard")
    ...
    Autorizacion(UsuarioAut, PasswordAut,){
            cy.log("✅⏳🏃‍➡️🏃‍♂️‍➡️ Inicia metodo Autorizacion")
...
//            cy.xpath("/html/body/div[3]/div[2]/div/mat-dialog-container/bt-authorization-helper/div[2]/form/fieldset/mat-form-field[3]/div/div[1]/div[3]/input")
            ...
            cy.log("🔚🏁🏃🏃‍♂️ Finaliza metodo Autorizacion")
