...
class PersonaNatural {
  ...
  AutorizacionLocal(Usuario_Auth, Password_Auth, motivo) {
  ...
  IdentificacionGeneralPersonaNatural(
    ...
    cy.get(".loading", { timeout: 60000 }).should("not.exist");
    cy.xpath(
      '//mat-radio-button[.//label[normalize-space()="Natural"]]//input[@type="radio"]',
      { timeout: 9000 }
    ).check({ timeout: 9000 });
  ...
  DatosGeneralesPersonaNatural(
    ...
    cy.xpath(`//label[contains(normalize-space(), '${textoGenero}')]`, {
      timeout: 6000,
    })
      .scrollIntoView()
      .should("be.visible")
    ...
    cy.get(".loading", { timeout: 60000 }).should("not.exist");
    cy.xpath(
      "//mat-step-header[contains(@class, 'mat-step-header') and .//div[contains(text(), 'Identificacion')]]"
    ).scrollIntoView();

    cy.xpath("(//input[@placeholder='Primer Apellido'])[1]").type(
      PrimerApellido,
      {
        timeout: 60000,
      }
    ...
    cy.contains("mat-label", "Estado Civil", { timeout: 6000 })
      ...
      .click({ force: true })
      .then(() => {
        cy.xpath(`//span[contains(normalize-space(), '${EstadoCivil}')]`, {
          timeout: 6000,
        }).click({
          force: true,
        });
    ...
    cy.contains("mat-label", "Grado Académico", { timeout: 6000 })
      ...
      .then(() => {
        cy.xpath(
          `//div[@role='listbox']//span[contains(normalize-space(), '${gradoAcademico}')]`,
          { timeout: 6000 }
        ).click({
          force: true,
        });
    ...
    cy.contains("mat-label", "Profesión", { timeout: 6000 })
      ...
      .then(() => {
        cy.xpath(
          `//div[@role='listbox']//span[normalize-space()='${profesion}']`
        ).click({ force: true });
      });
    ...
    cy.contains("mat-label", "Capacidades Especiales")
      ...
      .then(() => {
        cy.xpath(
          `//span[contains(normalize-space(.), '${capacidadesEspeciales}')]`,
          { timeout: 6000 }
        ).click({
          force: true,
        });
    ...
    cy.contains("mat-label", "Ocupación", { timeout: 6000 })
      ...
      .click({ force: true })
      .then(() => {
        cy.xpath(`//span[contains(normalize-space(.), '${ocupacion}')]`).click({
          force: true,
        });
      });
    if (tieneDobleNacionalidad === "Si") {
      ...
      cy.contains("mat-label", "2da. Nacionalidad", { timeout: 6000 })
        ...
        .then(() => {
          cy.xpath(
            "//mat-option/span[normalize-space(text())='" +
              segundaNacionalidad +
              "']"
          ).click({ force: true });
            ...
            cy.contains("mat-label", "Social Security Number", {
              ...
              .then(() => {
                cy.xpath(
                  ...
                  .then(() => {
                    cy.xpath(
                      `//mat-option[.//span[contains(@class,'mdc-list-item__primary-text') and contains(text(), '${UbicacionSegundaNacionalidad}')]]`
                    ).click({ force: true });
                  });
              });
          } else {
            cy.log(
              "Solo tiene nacionalidad doble pero no estadounidense o no esta el recuadro"
            );
          }
        });
    } else {
  ...
  PatrimonioPEP(
    ...
    cy.xpath(
      "//mat-label[normalize-space(.)='Empresa']/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
    )
      .filter(":visible:not([disabled])")
      .first()
      .scrollIntoView()
      ...
      .type(NombreEmpresaPEP, { force: true });
    cy.xpath(
      "//mat-label[normalize-space(.)='Tipo de documento']/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
    )
      .filter(":visible:not([disabled])")
      .first()
      .scrollIntoView()
      ...
      .then(() => {
        cy.get(".loading", { timeout: 60000 }).should("not.exist");
        cy.xpath(
          `//span[contains(normalize-space(), "${PatrimonioTipodeDocumentoPEP}")]`
        ).click({ force: true });
        cy.xpath(
          "//mat-label[normalize-space(.)='Identificación']/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
        )
          .filter(":visible:not([disabled])")
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          .should("be.visible")
          .type(PatrimonioIdentificacionPEP, { force: true });
      });
    cy.xpath(
      ...
      .then(() => {
        cy.wait(500);
        cy.xpath(
          `//span[contains(normalize-space(), "${PatrimonioActividadEconomicaPEP}")]`
        ).click({ force: true });
      });
  }
  PersonaPep(
    ...
    if (esPEP === "Si") {
      ...
      cy.xpath(
        "//div[contains(@class,'mat-step-text-label')][normalize-space(.)='Datos Generales Persona natural']"
      ).scrollIntoView({ force: true });
      cy.xpath(
        "//mat-label[normalize-space(.)='Institución']/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
      )
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView()
        ...
        .click({ force: true })
        .xpath(
          `//mat-option//span[normalize-space(text())= '${institucionPEP}']`
        )
        .click({ force: true })
        .wait(500)
        .then(() => {
          cy.get(".loading", { timeout: 60000 }).should("not.exist");
          cy.xpath(
            "//mat-label[normalize-space(.)='Cargo Ocupado']/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input",
            { timeout: 6000 }
          )
            .filter(":visible:not([disabled])")
            .first()
          ...
          cy.wait(500);
          cy.xpath(
            `//mat-option//span[normalize-space(text())= "${cargoOcupadoPEP}"]`
          ).click({ force: true });
          ...
          cy.contains("mat-label", "Periodo en que ocupó el cargo", {
            ...
            .click({ force: true })
            .then(() => {
              cy.xpath(`//span[contains(normalize-space(), "${periodoPEP}")]`)
                .should("be.visible")
                .should("not.be.disabled")
                .click({ force: true });
              cy.wait(3000);
      ...
      if (EmpresaJuridicaPEP === "Empresa") {
        ...
        cy.xpath(`//span[contains(text(), '${EmpresaJuridicaPEP}')]`).click({
          force: true,
        });
        cy.wait(500);
        this.PatrimonioPEP(
        ...
        EmpresaJuridicaPEP === "Federaciones/organizaciones no lucrativas"
      ) {
        cy.xpath(`//span[contains(text(), '${EmpresaJuridicaPEP}')]`).click({
          force: true,
        });
      ...
      cy.xpath(
        "//mat-step-header[.//span[text()='4'] and .//div[normalize-space(text())='Dirección']]"
      ).scrollIntoView({ force: true });
      cy.xpath(
        "//span[@class='mdc-button__label'][normalize-space()='Siguiente']"
      )
  ...
  ParentescosPEP(
    ...
    tieneHijxPEP,
    tipoHijxPEP,
    primerApellidoHijxPEP,
    primerNombreHijxPEP,
    direccionHijxPEP,
    fechaNacimientoHijxPEP,
    tieneHermanosAbueloPEP,
    tipoParentescoHermanoAbueloPEP,
    primerapellidoHermanoAbueloPEP,
    primerNombreHermanoAbueloPEP,
    tieneCuniadoPEP,
    tipoParentescoCuniadoPEP,
    primerApellidoCuniadoPEP,
    primerNombreCuniadoPEP
  ) {
    ...
    if (this.esPEP === "Si") {
      if (tieneMamaPEP === "Si") {
        ...
        // Primer Nombre - madre
        cy.xpath(
          "//label[normalize-space()='Primer Nombre']/following::input[1]"
        )
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
        ...
        cy.log("No se llena datos de la madre, ya que se escribió No");
      }
      if (tienePapaPEP === "Si") {
        cy.xpath(
          "//label/mat-label[text()='Primer Apellido']/ancestor::div[contains(@class, 'mat-mdc-text-field-wrapper')]/descendant::input"
        )
          .filter(":visible:not([disabled])")
          .eq(1)
          .scrollIntoView()
          .should("be.visible")
          .type(apellidoPapaPEP, { force: true });
        cy.xpath(
          "//label/mat-label[text()='Primer Nombre']/ancestor::div[contains(@class, 'mat-mdc-text-field-wrapper')]/descendant::input"
        )
          .filter(":visible:not([disabled])")
          .eq(1)
          .scrollIntoView()
          .should("be.visible")
          .type(primerNombrePapaPEP, { force: true });

        cy.xpath(
          "//label/mat-label[text()='Dirección']/ancestor::div[contains(@class, 'mat-mdc-text-field-wrapper')]/descendant::input"
        )
          .filter(":visible:not([disabled])")
          .eq(1)
          .scrollIntoView()
          .should("be.visible")
          .type(direccionPapaPEP, { force: true });
      } else {
        cy.log("No tiene papá");
      }
      ...
      if (tieneSuegrxPEP === "Si") {
        ...
        //Opcion parentesco
        cy.xpath(
          "//label[.//mat-label[normalize-space()='Parentesco']]/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
        )
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          ...
          .then(() => {
            ...
            cy.wait(500);
            cy.xpath(
              `//mat-option[.//span[normalize-space()="${tiposuegrxPEP}"]]`
            ).click({ force: true });
          });
        ...
        cy.xpath(
          ...
          .should("be.visible")
          .type(apellidosuegrxPEP, { force: true });
        ...
        cy.xpath(
          ...
          .should("be.visible")
          .type(primerNombreSuegrxPEP, { force: true });
        ...
        cy.log("No tiene suegro");
      }

      if (tieneHijxPEP === "Si") {
        cy.log("Ingreso a flujo pep ingreso de hijo o hija");
        cy.xpath(
          "//span[@class='mdc-tab__text-label'][normalize-space()='Hijos']"
        )
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          .should("be.visible")
          .click({ force: true });
        cy.xpath("//label/mat-label[text()='Parentesco']")
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          .should("be.visible")
        ...
        cy.wait(200);
        cy.xpath(
          `//mat-option/span[normalize-space(text())='${tipoHijxPEP}']`
        ).click({ force: true });
        cy.xpath(
          "//label/mat-label[text()='Primer Apellido']/ancestor::div[contains(@class, 'mat-mdc-text-field-wrapper')]/descendant::input"
        )
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(primerApellidoHijxPEP, { force: true });
        cy.xpath(
          "//label/mat-label[text()='Primer Nombre']/ancestor::div[contains(@class, 'mat-mdc-text-field-wrapper')]/descendant::input"
        )
          .filter(":visible:not([disabled])")
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(primerNombreHijxPEP, { force: true });
        ...
        cy.xpath(
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(direccionHijxPEP, { force: true });

        cy.xpath(
          "//label/mat-label[text()='Fecha Nacimiento']/ancestor::div[contains(@class, 'mat-mdc-text-field-wrapper')]/descendant::input"
        )
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          .should("be.visible")
          .type(fechaNacimientoHijxPEP, { force: true });
        cy.xpath(
          "//span[@class='mdc-button__label'][normalize-space()='Agregar']"
        )
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
      ...
      if (tieneHermanosAbueloPEP === "Si") {
        cy.log("Ingreso de flujo pep hermanos o abuelos");

        cy.xpath(
          "//span[@class='mdc-tab__text-label'][normalize-space()='Hermanos y Abuelos']"
        )
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
        ...
        cy.wait(200);
        cy.xpath(
          `//mat-option/span[normalize-space(text())='${tipoParentescoHermanoAbueloPEP}']`
        ).click({ force: true });
        cy.xpath(
          "//label/mat-label[text()='Primer Apellido']/ancestor::div[contains(@class, 'mat-mdc-text-field-wrapper')]/descendant::input"
        )
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(primerapellidoHermanoAbueloPEP, { force: true });
        cy.xpath(
          "//label/mat-label[text()='Primer Nombre']/ancestor::div[contains(@class, 'mat-mdc-text-field-wrapper')]/descendant::input"
        )
          .filter(":visible:not([disabled])")
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(primerNombreHermanoAbueloPEP, { force: true });
        ...
        cy.log("No entra a este flujo ya que no tiene Hermano o abuelo");
      }

      if (tieneCuniadoPEP === "Si") {
        cy.xpath(
          "//span[@class='mdc-tab__text-label'][normalize-space()='Cuñados']"
        )
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
        ...
        cy.wait(200);
        cy.xpath(
          `//mat-option/span[normalize-space(text())='${tipoParentescoCuniadoPEP}']`
        ).click({ force: true });
        cy.xpath(
          "//label/mat-label[text()='Primer Apellido']/ancestor::div[contains(@class, 'mat-mdc-text-field-wrapper')]/descendant::input"
        )
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(primerApellidoCuniadoPEP, { force: true });
        cy.xpath(
          "//label/mat-label[text()='Primer Nombre']/ancestor::div[contains(@class, 'mat-mdc-text-field-wrapper')]/descendant::input"
        )
          .filter(":visible:not([disabled])")
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(primerNombreCuniadoPEP, { force: true });
        ...
        cy.log(
          "No ingreso cuniados en flujo PEP, por lo que no ingresa a este flujo"
        );
      }
  ...
  esCasado(
    ...
    cy.get(".loading", { timeout: 80000 }).should("not.exist");
    cy.wait(3000);
    if (this.EstadoCivil === "Casado" && this.esPEP === "No") {
      ...
      cy.xpath('//input[@placeholder="Primer Nombre"]')
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView()
        .should("be.visible")
        .type(nombreConyugue, { force: true });
      ...
      cy.get(".mdc-floating-label")
        ...
        .then(() => {
          cy.xpath(
            `//mat-option[.//span[normalize-space()="${tipoCelularConyugue}"]]`
          ).click({ force: true });
        });
      cy.xpath(
  ...
  escasadoPEP(
    ...
    salarioReferenciaConyuguePEP,
    direccionReferenciaLaboralConyuguePEP,
    tipoCorreoContactoConyuguePEP,
    CorreoContactoConyuguePEP,
    tipoTelefonoContactoConyuguePEP,
    telefonoContactoConyugue,
    //
    nombreRefJuridica,
    fechaIngresoRefJuridica,
    esEgresadoRefJuridica,
    fechaEgresoRefJuridica,
    puestoRefJuridica,
    salarioRefJuridica,
    direccionRefJuridica,
    tipoCorreoRefJuridica,
    correoRefJuridica,
    tipoTelefonoRefJuridica,
    telefonoRefJuridica,
    tieneEmpresaConyuguePEP,
    nombreEmpresaConyuguePEP,
    ...
    if (this.EstadoCivil === "Casado" && this.esPEP === "Si") {
      if (tipoConyugue === "FEMENINO") {
        cy.get("#mat-radio-20-input").click({ force: true });
      } else {
        cy.get("#mat-radio-21-input").click({ force: true });
      ...
      cy.xpath(
        "//mat-step-header[.//div[contains(@class, 'mat-step-text-label') and normalize-space(text())='Cónyuge']]"
      ).then(($el) => {
      ...
      cy.wait(500);
      cy.xpath(
        "//label[.//mat-label[normalize-space()='Seleccione una fecha']]/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
      )
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView()
      ...
      cy.xpath("(//mat-label[contains(text(),'Actividad Económica')])[2]")
        ...
        .then(() => {
          cy.xpath(
            `//span[contains(normalize-space(), "${actividadEconomicaConyuguePEP}")]`
          ).click({ force: true });
        });
      ...
      cy.xpath("(//mat-label[contains(text(),'Profesión')])[2]")
        ...
        .then(() => {
          cy.xpath(
            `//div[@role='listbox']//span[contains(normalize-space(), '${profesionConyuguePEP}')]`
          ).click({ force: true });
        });
      cy.xpath(
        "//div[contains(@class,'mat-step-label')]//div[contains(text(),'Parentescos')]"
      ).scrollIntoView({ force: true });

      cy.xpath(
        "//mat-label[contains(text(), 'PASAPORTE')]/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
      )
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView()
        .should("be.visible")
        .click({ force: true })
        .type(pasaporteConyuguePEP, { force: true });
      ...
      cy.xpath(
        ...
        .click({ force: true });
      cy.xpath(
        `//mat-option[contains(normalize-space(.), "${nacionalidadPasaporteConyuguePEP}")]`
      ).click({ force: true });
      ...
      if (tieneSegundaNacionalidadConyuguePEP === "Si") {
        ...
        cy.xpath("(//mat-label[contains(text(),'2da. Nacionalidad')])[2]")
          ...
          .then(() => {
            cy.xpath(
              `//mat-option[contains(normalize-space(.), "${UbicacionSegundaNacionalidadConyuguePEP}")]`
            ).click({ force: true });
          });
      } else {
      ...
      cy.xpath(
        "//div[@class='mat-step-label mat-step-label-active']/div[@class='mat-step-text-label ng-star-inserted' and normalize-space()='Parentescos']"
      ).scrollIntoView({ force: true });
      cy.wait(3000);
      ...
      cy.wait(1000);
      cy.xpath(
        "//mat-label[normalize-space()='Ingrese una ubicación']/ancestor::mat-form-field//input"
      )
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView()
        .should("be.visible")
        .type(ubicacionconyugue, { force: true });
      ...
      cy.xpath(
        ...
        .click({ force: true });
      cy.wait(1000);
      cy.xpath("//mat-label[contains(text(),'Tipo de Correo')]")
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView()
        .should("be.visible")
        ...
        .then(() => {
          ...
          cy.xpath(
            `//mat-option/span[contains(normalize-space(.), "${tipoCorreoConyuguePEP}")]`
          ).click({ force: true });
        });
      cy.xpath(
        ...
        .scrollIntoView()
        .should("be.visible")
        .type(correoConyuguePEP, { force: true })
        .then(() => {
          cy.xpath(
      ...
      cy.xpath("(//mat-label[contains(text(),'Tipo de Teléfono')])[1]")
        ...
        .then(() => {
          cy.wait(500);
          cy.xpath(
            `//mat-option[.//span[normalize-space()="${tipoTelefonoConyuguePEP}"]]`
          ).click({ force: true });
        });
      ...
      cy.xpath(
        ...
        .should("be.visible")
        .clear({ force: true })
        .type(telefonoConyuguePEP, { force: true });
      ...
      if (referenciaLaboralConyuguePEP === "NATURAL") {
        ...
        cy.xpath("//mat-label[normalize-space()='Salario']")
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          .should("be.visible")
          ...
          .then(() => {
            cy.xpath(
              `//mat-option/span[contains(normalize-space(.), "${salarioReferenciaConyuguePEP}")]`
            ).click({ force: true });
          });
        ...
        cy.xpath(
          ...
          .then(() => {
            cy.wait(3000);
            function selectDropdownOption(index = 0) {
        ...
        cy.xpath(
          "//span[@class='mdc-button__label'][normalize-space()='Buscar']"
        )
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
        ...
        cy.xpath(
          ...
          .then(() => {
            cy.xpath(
              `//mat-option/span[contains(normalize-space(.), "${tipoCorreoContactoConyuguePEP}")]`
            ).click({ force: true });
            cy.wait(500);
            cy.xpath(
              "//mat-label[.='Correo']/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
            )
              .filter(":visible:not([disabled])")
              .first()
              .scrollIntoView()
              .should("be.visible")
              .type(CorreoContactoConyuguePEP, { force: true });
            //boton agregar
            cy.xpath(
        ...
        //Telefono
        cy.xpath(
          "//mat-label[.='Tipo de Teléfono']/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//mat-select"
        )
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          ...
          .then(() => {
            cy.wait(1000);
            cy.xpath(
              `//mat-option[.//span[normalize-space()="${tipoTelefonoContactoConyuguePEP}"]]`
            ).click({ force: true });
            cy.xpath(
              "//mat-label[.='Teléfono']/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
            )
              .filter(":visible:not([disabled])")
              .first()
              .scrollIntoView()
        ...
        cy.xpath("//input[@placeholder='Ingrese Nombre de la Empresa']")
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          .should("be.visible")
          .type(nombreRefJuridica);

        cy.xpath("//input[@placeholder='Fecha Ingreso']")
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          .should("be.visible")
          .type(fechaIngresoRefJuridica);

        if (esEgresadoRefJuridica === "Si") {
          cy.xpath("//input[@placeholder='Fecha Egreso']")
            .filter(":visible:not([disabled])")
            .first()
            .scrollIntoView()
            .should("be.visible")
            .type(fechaEgresoRefJuridica);
        } else {
          cy.log("No tiene fecha de egreso");
        }

        cy.xpath("//input[@placeholder='Puesto']")
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          .should("be.visible")
          .type(puestoRefJuridica);
        ...
        cy.xpath(
          `//mat-option/span[contains(normalize-space(.), "${salarioRefJuridica}")]`
        ).click({ force: true });
        ...
        cy.xpath(
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(direccionRefJuridica, { force: true });
        cy.wait(500);
        cy.get('div[role="listbox"] mat-option').eq(0).click({ force: true });
        ...
        cy.wait(500);
        cy.xpath(
          `//mat-option/span[contains(normalize-space(.), "${tipoCorreoRefJuridica}")]`
        ).click({ force: true });
        cy.xpath(
          "//mat-label[.='Correo']/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
        )
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(correoRefJuridica, { force: true });
        cy.xpath("//button[.//span[normalize-space()='Agregar']]")
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
          .should("be.visible")
        ...
        cy.wait(500);
        cy.xpath(
          `//mat-option[.//span[normalize-space()="${tipoTelefonoRefJuridica}"]]`
        ).click({ force: true });
        cy.xpath(
          "//mat-label[.='Teléfono']/ancestor::div[contains(@class,'mat-mdc-text-field-wrapper')]//input"
        )
          ...
          .should("be.visible")
          .clear({ force: true })
          .type(telefonoRefJuridica, { force: true });
        cy.xpath("//button[.//span[normalize-space()='Agregar']]")
          .filter(":visible:not([disabled])")
          .first()
          .scrollIntoView()
      ...
      if (tieneEmpresaConyuguePEP === "Si") {
        ...
        cy.xpath(
          ...
          .filter(":visible")
          .type(nombreEmpresaConyuguePEP, { force: true });
        ...
        cy.xpath(
          ...
          .tab()
          .xpath(
            `//mat-option//span[normalize-space(text())= '${categoriadeNegocioConyuguePEP}']`
          );
        cy.wait(500);
        cy.get(".mat-mdc-autocomplete-panel mat-option").eq(0).click();
        cy.xpath(
        ...
        cy.log("No cuenta con negocio PEP");
      }
  ...
  direccionCliente(aniosResidir, ubicacionResidencia) {
    if (this.esPEP === "Si" && this.EstadoCivil === "Casado") {
      cy.wait(2000);
      cy.get(".loading", { timeout: 60000 }).should("not.exist");
      cy.xpath(
      ...
      cy.xpath("(//button[.//span[text()='Siguiente']])[6]")
        ...
        .click({ force: true });
      cy.get(".loading", { timeout: 90000 }).should("not.exist");
    } else if (this.esPEP === "No" && this.EstadoCivil === "Casado") {
  ...
  contactoCliente(
    ...
    if (this.esPEP === "Si" && this.EstadoCivil === "Casado") {
      ...
      cy.xpath(
        ...
        .then(() => {
          cy.xpath(
            `//mat-option/span[contains(normalize-space(.), "${tipoCorreoContactoCliente}")]`
          ).click({ force: true });
        });
      cy.wait(500);
      ...
      cy.xpath(
        ...
        .then(() => {
          ...
          cy.xpath(
            `//mat-option[.//span[normalize-space()="${tipoTelefonoContactoCliente}"]]`
          ).click({ force: true });
          cy.wait(500);
      ...
      cy.xpath("(//button[.//span[normalize-space()='Siguiente']])[7]")
        ...
        .should("be.visible")
        .click({ force: true });
    } else if (this.esPEP !== "Si" && this.EstadoCivil === "Casado") {
  ...
  dependenciaEconomica(
    ...
    if (
      ...
      cy.wait(500);
      cy.xpath(
        `//mat-option//span[contains(normalize-space(.), "${parentescoDependenciaEconomica}")]`
      ).click({
        force: true,
      });
      cy.wait(500);
      ...
      cy.xpath("(//button[.//span[normalize-space()='Siguiente']])[16]")
        ...
        .click({ force: true });
      cy.get(".loading", { timeout: 60000 }).should("not.exist");
    } else if (+this.FechaNacimientoCliente.split("/")[2] >= 2007) {
  ...
  Dependientes(
    ...
    if (
      ...
      cy.xpath(
        ...
        .then(() => {
          cy.xpath(
            `//mat-option//span[contains(normalize-space(.), "${parentescoDependiente}")]`
          ).click({ force: true });
        });
      ...
      cy.xpath(
        ...
        .scrollIntoView()
        .should("be.visible")
        .type(apellidoDependiente, { force: true });
      cy.wait(500);
      cy.xpath(
        ...
        .scrollIntoView()
        .should("be.visible")
        .type(primerNombreDependiente, { force: true });
      cy.wait(500);
  ...
  perfilEconomico(
    ...
    institucionPerfilEconomico,
    tieneOtrosIngresos,
    montoOtrosIngresos,
    observacionesOtrosIngresos
  ) {
    ...
    if (this.esPEP === "Si" && this.EstadoCivil === "Casado") {
      ...
      cy.xpath(
        ...
        .then(() => {
          cy.xpath(
            `//span[contains(normalize-space(), "${actividadEconomicaCliente}")]`
          ).click({ force: true });
        });
      cy.wait(500);
      cy.xpath(
        ...
        .then(() => {
          cy.xpath(
            `//mat-option//span[contains(normalize-space(.), "${claseCliente}")]`
          ).click({ force: true });
        });
      cy.xpath(
      ...
      cy.xpath(
        ...
        .scrollIntoView()
        .should("be.visible")
        .type(institucionPerfilEconomico, { force: true });
      cy.wait(500);
      cy.get(".mat-mdc-autocomplete-panel mat-option")
        .eq(0)
        .click({ force: true });
      ...
      cy.get(".mat-mdc-autocomplete-panel mat-option")
        .eq(0)
        .click({ force: true });
    } else if (this.EstadoCivil === "Casado" && this.esPEP !== "Si") {
    ...
    if (tieneOtrosIngresos === "Si") {
      cy.xpath("//mat-label[normalize-space()='Ingresos']")
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView()
        .should("be.visible")
        .click({ force: true });
      cy.xpath(`//span[normalize-space()='${montoOtrosIngresos}']`)
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView()
        .should("be.visible")
        .click({ force: true });
      cy.xpath("//textarea[@formcontrolname='observaciones']")
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView()
        .should("be.visible")
        .type(observacionesOtrosIngresos);
      cy.xpath("//button[.//span[contains(text(), 'Agregar')]]")
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView()
      ...
      cy.log(
        "No entra a este paso ya que no tienen otros ingresos en su perfil economico"
      );
    }
  ...
  flujoFatca(
    ...
    if (
      ...
      // Función CORREGIDA para marcar checkboxes basada en "Si" o "No"
      const marcarCheckboxSiNo = (textoLabel, valor) => {
        ...
        cy.xpath(
          ...
          // Solo hacer click si el estado actual no coincide con el deseado
          if (debeMarcar !== estaMarcado) {
            cy.wrap($checkbox)
              .click({ force: true })
              .should(debeMarcar ? "be.checked" : "not.be.checked");
          }
        });
      };
      ...
      if (tieneNumeroUsaFatcaCliente === "Si") {
        ...
        cy.xpath(
          `//mat-option[.//span[normalize-space()="${tipoCelularFatcaCliente}"]]`
        ).click({
          force: true,
        });
        cy.xpath(
      ...
      if (tieneZipUsaFatcaCliente === "Si") {
        ...
        cy.log("no entra al flujo ua qie no ingreso ");
      }
    } else {
  ...
  referenciasLaborales(
    ...
    tieneFechaEgresoReferenciaLaboralCliente,
  ...
  referenciasBancarias(
    ...
    if (tieneReferenciasBancarias === "Si") {
      // cy.xpath(
      ...
      if (tipodeCuentaReferenciaCliente === "Cuentas") {
        ...
        cy.xpath("//input[@placeholder='Número Tarjeta']")
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(numeroTarjetaReferenciaBancariaCliente, { force: true });
        cy.wait(500);
        cy.xpath(
    ...
    and contains(normalize-space(text()), '${productoTarjetaReferenciaLaboralCliente}')
        ...
        cy.xpath("//input[@placeholder='Límite de crédito']")
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(limiteCreditoTarjetaReferenciaBancariaCliente, { force: true });
        ...
        cy.xpath(
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(institucionTarjetaReferenciaLaboralCliente, { force: true });
        cy.wait(500);
        ...
        cy.xpath(
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(numeroCompleto, { force: true });
        cy.wait(100);
        cy.xpath(
          "//mat-label[contains(text(),'Producto Cuenta')]/ancestor::div[contains(@class,'mat-mdc-form-field-flex')]//mat-select"
        )
        ...
        cy.xpath(
          ...
          .scrollIntoView()
          .should("be.visible")
          .type(institucionPrestamoReferenciaLaboralCliente, { force: true });
        cy.wait(500);
        cy.get(".mat-mdc-option").eq(0).click();
      } else {
  ...
  referenciasComerciales(
    ...
    if (tieneReferenciasComerciales === "Si") {
      // cy.xpath(
      ...
      cy.xpath(
        ...
        .scrollIntoView()
        .should("be.visible")
        .type(nombreReferenciaComercialCliente, { force: true });
      cy.get(".loading", { timeout: 60000 }).should("not.exist");
      // cy.get(".mat-mdc-option").eq(0).click();
      // cy.get(".loading", { timeout: 60000 }).should("not.exist");
      cy.wait(500);
      ...
      cy.wait(500);
      cy.xpath(
        "//mat-label[normalize-space(text())='Dirección']/ancestor::mat-form-field//input"
      )
        .filter(":visible:not([disabled])")
        .first()
        .scrollIntoView({ force: true })
        .should("be.visible")
        .click({ force: true })
        .type(direccionReferencialComercialCliente, { force: true });
      ...
      cy.xpath(
        ...
        .should("be.visible")
        .clear({ force: true })
        .type(numeroTelefonoReferenciaComercialCliente, { force: true });
      cy.xpath(
        "//button[contains(@class, 'mat-mdc-outlined-button') and .//span[normalize-space()='Agregar']]"
      )
        .filter(":visible:not([disabled])")
  ...
  referenciasFamiliares(
    ...
    if (tieneReferenciasFamiliares === "Si") {
      ...
      cy.wait(2000);
      // cy.xpath("//button[.//span[normalize-space()='Editar']]")
      //   .filter(":visible:not([disabled])")
      //   .first()
      //   .scrollIntoView()
      //   .should("be.visible")
      ...
      cy.xpath(
        ...
        .scrollIntoView()
        .should("be.visible")
        .type(apellidoReferenciaFamiliarCliente, { force: true });
      cy.wait(500);
      cy.xpath(
        ...
        .scrollIntoView()
        .should("be.visible")
        .type(nombreReferenciaFamiliarCliente, { force: true });
      ...
      cy.xpath(
        ...
        .should("be.visible")
        .clear({ force: true })
        .type(telefonoReferenciaFamiliarCliente, { force: true });
      cy.wait(1000);
  ...
  referenciasPersonales(
    ...
    if (tieneReferenciasPersonales === "Si") {
      // cy.xpath(
      ...
      cy.xpath(
        ...
        .scrollIntoView()
        .should("be.visible")
        .type(apellidoreferenciaPersonalCliente, { force: true });
      cy.xpath(
        ...
        .scrollIntoView()
        .should("be.visible")
        .type(nombreReferenciaPersonalCliente, { force: true });
      cy.xpath(
      ...
      cy.xpath(
        ...
        .should("be.visible")
        .clear({ force: true })
        .type(telefonoReferenciaPersonalCliente, { force: true });
      ...
      cy.log("No tiene referencias personales adicionales");
    }
    // cy.xpath(
  ...
  digitalizacionDocumentos() {
    ...
    // cy.wait(1000);
    // cy.xpath(
    //   "(//div[contains(@class, 'container-local') and not(contains(@style, 'display: none'))])[1]"
    // )
    //   .filter(":visible:not([disabled])")
    //   .first()
    //   .find("input[type='file']")
    //   .first()
    //   .attachFile("DNI.jpg", { force: true });
    ...
    cy.window().then(() => {
      const $rtnBtn = Cypress.$(
        "tr:has(td:contains('DNI')) button:has(mat-icon:contains('add'))"
      );

      if ($rtnBtn.length > 0 && $rtnBtn.is(":visible")) {
        cy.log("Documento DNI sí aplica");
